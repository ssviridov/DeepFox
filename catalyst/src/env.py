...
from .env_wrappers import AnimalAIWrapper

from a2c_ppo_acktr.aai_config_generator import SingleConfigGenerator, ListSampler, HierarchicalSampler
from a2c_ppo_acktr.preprocessors import MetaObs
...
class AnimalEnvWrapper(EnvironmentSpec):
    def __init__(
        ...
        **params
        ...
        gen_config = ListSampler.create_from_dir(config_dir)

        env = AnimalAIWrapper(rank=self._sampler_id, config_generator=gen_config, **params)

        self.env = MetaObs().wrap_env(env)
