...
def create_env(seed=None):
    ...
    arena_config = ArenaConfig(
        "aai_resources/configs2/1-food/food.yaml"
    )
...
if __name__ == "__main__":
    ...
    gen_config = SingleConfigGenerator.from_file("aai_resources/configs2/1-food/food.yaml")
    agent = Agent('submission/data/pretrained/config3-150M-clf/sub_config.yaml')
    env = create_env(3)
